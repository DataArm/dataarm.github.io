var questions = [
  ...
  ["<ul><li>Who's using that 'IP Address'</li><li>and on what network switch?</li></ul><p>Even if you're not the 'Network admin'</p>"],
  ...
  ["<ul><li>What 'regions' do we use?</li><li>Can we shut down any one to save money?</li></ul><p>Even if you're not an 'AWS expert'</p>"],
  ...
  ["<ul><li>What 'CNAME' records are we using?</li><li>Any of them pointing to external providers?</li></ul><p>Even if you're not a 'DNS expert'</p>"],
  ...
  ["<ul><li>What 'Java versions' are we using?</li><li>Is any one connected to the world directly?</li></ul><p>Even if you're the 'technical writer'</p>"],
  ...
  ["<ul><li>Are we 'monitoring' all our 'servers', 'services'</li><li>and 'running processes'?</li></ul><p>Even if you have more than 5 monitoring systems</p>"],
  ["<ul><li>Who's 'AD password' expires this week?</li><li>And next week?</li></ul><p>Even if you're the 'UNIX admin'</p>"],
  ["<ul><li>What 'Windows servers' are joined to the domain?</li><li>Which ones aren not?</li></ul><p>Even if you're the 'UNIX admin'</p>"],
